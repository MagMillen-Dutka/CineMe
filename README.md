...
A user friendly application designed to find and rate movies of your choice. This encompasses HTML, CSS, JavaScript and JQuery into one application with zero pre-existing code.

It is styled via standard style.css file, along with the use of w3.CSS inline styling components.

## User Story
As a film fan I want to be able to quickly see top trending films 
So that I can choose one that I like to watch
